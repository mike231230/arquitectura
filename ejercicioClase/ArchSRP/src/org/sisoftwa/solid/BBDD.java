...
public class BBDD {
	private static final String GENERO_FANTASTICO = "fantastico";
	...
	public static Map<String, List<Pelicula>> PELIS_POR_DIRECTOR = Arrays.stream(TODAS).collect(Collectors.groupingBy(Pelicula::getDirector));
}
